...
* Hugging Face Transformers (language modeling and classification)

Features
* Text Analysis using a custom-trained machine learning model powered by Hugging Face Transformers.
* Abuse Intensity Scoring to help users understand the severity of the interactions
*  Clean and simple web interface for ease of use.
